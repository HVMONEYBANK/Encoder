...
async def help_message(app, message):
    ...
    await app.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('My Master', url='Hv_Cartoons')
                ]
            ]
        ),
